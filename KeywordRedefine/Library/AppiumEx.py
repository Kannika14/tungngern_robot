...
class AppiumEx(AppiumLibrary):

    # create a new keyword called "get application instance"
    # Public, element lookups

    def appium_get_driver_instance(self):
        """return current session Appium.
        """
        return self._current_application()

    def appium_set_driver_instance(self, oAppiumInfo):
        """set current session Appium.
        |oAppiumInfo=${AppInfo}|
        """
        self._cache.current = oAppiumInfo.driver

    def exappium_open_application(self, remote_url, alias=None, **kwargs):
    ...
    def exappium_close_application(self, oAppiumInfo=None):
    ...
    def exappium_click_element(self, locator, oAppiumInfo=None):
    ...
    def exappium_clear_text(self, locator, oAppiumInfo=None):
    ...
    def exappium_input_text(self, locator, text, oAppiumInfo=None):
    ...
    def exappium_input_password(self, locator, text, oAppiumInfo=None):
    ...
    def exappium_hide_keyboard(self, oAppiumInfo=None, key_name=None):
    ...
    def exappium_element_should_be_disabled(self, locator, loglevel='INFO', oAppiumInfo=None):
    ...
    def exappium_element_should_be_enabled(self, locator, loglevel='INFO', oAppiumInfo=None):
    ...
    def exappium_element_name_should_be(self, locator, expected, oAppiumInfo=None):
    ...
    def exappium_element_value_should_be(self, locator, expected, oAppiumInfo=None):
    ...
    def exappium_element_attribute_should_match(self, locator, attr_name, match_pattern, regexp=False,
                                                 oAppiumInfo=None):
    ...
    def exappium_element_should_not_contain_text(self, locator, expected, message='', oAppiumInfo=None):
    ...
    def exappium_element_text_should_be(self, locator, expected, message='', oAppiumInfo=None):
    ...
    def exappium_set_network_connection_status(self, connectionStatus, oAppiumInfo=None):
    ...
    def exappium_get_webelement(self, locator, oAppiumInfo=None):
    ...
    def exappium_get_webelements(self, locator, oAppiumInfo=None):
    ...
    def exappium_get_element_attribute(self, locator, attribute, oAppiumInfo=None):
    ...
    def exappium_get_elements_attribute(self, locator, attribute, oAppiumInfo=None):
        """Get element attribute using given attribute: name, value,...
    ...
    def exappium_get_element_attribute_index(self, locator, attribute, index, oAppiumInfo=None):
        """Get element attribute using given attribute: name, value,...
    ...
    def exappium_get_element_location(self, locator, oAppiumInfo=None):
    ...
    def exappium_get_element_size(self, locator, oAppiumInfo=None):
        """Get element size
    ...
    def exappium_get_text(self, locator, oAppiumInfo=None):
    ...
    def exappium_get_matching_xpath_count(self, xpath, oAppiumInfo=None):
    ...
    def exappium_xpath_should_match_x_times(self, xpath, count, oAppiumInfo=None, error=None, loglevel='INFO'):
    ...
    def exappium_wait_until_page_contains_element(self, locator, oAppiumInfo=None, timeout=None, error=None):
    ...
    def exappium_wait_until_page_does_not_contain_element_atlas(self, locator, oAppiumInfo=None, timeout=None, error=None):
    ...
    def exappium_local_capture_screenshot(self, sn, filename=None):
    ...
    def exappium_capture_page_screenshot(self, filename=None, oAppiumInfo=None):
    ...
    def exappium_capture_page_screenshot_at_verify_point(self, filename=None, oAppiumInfo=None):
        """Takes a screenshot of the current page and embeds it into the log.
    ...
    def exappium_swipe(self, start_x, start_y, offset_x, offset_y, oAppiumInfo=None, duration=1000):
        """
    ...
    """def exappium_long_press(self, locator, oAppiumInfo=None, duration=2000):
